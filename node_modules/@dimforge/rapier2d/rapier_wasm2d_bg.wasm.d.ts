...
export function rawrigidbodyset_rbRestrictTranslations(a: number, b: number, c: number, d: number, e: number): void;
...
export function rawcolliderset_createCollider(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number): void;
